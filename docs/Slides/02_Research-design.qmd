...
::: {.column width="70%"}
-   "Are we human, or are we denser?" ^[Lyric from the 2008 song *Human* by *The Killers*]
:::
...
![](../pics/lines-illusion.jpg){.fragment .current-visible .absolute right=0 top=30% height=300}

![](../pics/elephant-legs.jpg){.fragment .current-visible .absolute right=0 top=30% height=200}
:::


::: {.column width="70%"}
-   "Are we human, or are we <s>denser</s> dancer?" ^[Lyric from the 2008 song *Human* by *The Killers*. There was some confusion about the lyrics among fans and the band's frontman clarified that he sings 'dancer', not 'denser'. "I guess it bothers people that it's not grammatically correct, but I think I'm allowed to do whatever I want", he said. Apparently, the lyric alludes to a quote from journalist Hunter S. Thompson about how "America is raising a generation of dancers, afraid to take one step out of line" [(https://www.digitalspy.com/music/a134344/flowers-clears-up-human-confusion/)](https://www.digitalspy.com/music/a134344/flowers-clears-up-human-confusion/)]
:::

. . . 

:::{.column width="70%"}
- gggggggggggggggggggggggggg g g g g oncoin NN OSN onsoDUIN OUICN NS ONSDO NIOSDN  NSDON OINSDI NSOI NSIODN OISND OINISND IOSDNO INSODI NIOSDOIN IONSO NSODN OSDN ONSDO]
:::

![](../pics/day-data.jpg){.absolute right=-5% top=30% height=200}

. . . 

:::{.column width="70%"}
- ouihnvounfdb m ipodfnjopi nmiomn iodafj iomdfo injodfi 
:::
. . .
...
[^1]: Song lyrics by *The Killers*

[^2]: Song lyrics by *The Killers*
