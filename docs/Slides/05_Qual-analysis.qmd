...
## Thematic coding {background-image="../pics/user-coding1.webp" background-opacity="1"  background-size="45% 93%" background-position="top right 0px"}
...
## Coding in practice {background-image="../pics/user-coding1.webp" background-opacity="1"  background-size="45% 93%" background-position="top right 0px"}
...
![](../pics/structured-codes1.png){.absolute left="1%"}
![](../pics/structured-codes2.png){.absolute right="1%"}
