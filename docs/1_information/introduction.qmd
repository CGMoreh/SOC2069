...
This will be some very veryu very long text here to check what can be done so that it doesn't clash with the picture on the right hand side...
...
![](../pics/chord.gif){.absolute top=100 right=10 height=300px}
