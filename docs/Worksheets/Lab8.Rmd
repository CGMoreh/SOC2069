...
# If you need to first install the packages, remove the hashtag from in front of the `install.packages()` command to un-comment the command and make it executable in R
    ...
    install.packages("jtools")  # A new package for better summaries of regression models
...
4.  **Load the *ukhls_w8.rds* dataset** to an object in the session Environment; let's call that object "ukhls" this time
    ...
    <span style="color:red">`r fontawesome::fa("wrench")`   As you manipulate the dataset downloaded with the project folder, you may accidentally overwrite it with incorrect transformations. To avoid this, it's a good idea to replace the dataset in your folder with one in its original state, which you can download from here: </span> **[https://cgmoreh.github.io/SOC2069/SOC2069-Statistical-analysis/ukhls_w8.rds](https://cgmoreh.github.io/SOC2069/SOC2069-Statistical-analysis/ukhls_w8.rds)**
