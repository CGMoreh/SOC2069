...
$$
\begin{aligned}
  \color{Blue}{\widehat{subjective\:wellbeing}} &\color{Lightgrey}{=} \color{Red}{a} \color{Lightgrey}{+} \color{Red}{b}\color{Lightgrey}{\times}\color{Blue}{age} \\
  
  \color{Blue}{wellbeing} &\color{Lightgrey}{\sim} \color{Red}{1} \color{Lightgrey}{+} \color{Red}{b}\color{Lightgrey}{\times}\color{Blue}{\text{age_dv}}
\end{aligned}
$$
