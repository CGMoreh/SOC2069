...
```
Sometimes it may be useful to add additional information to the graph, such as a straight line representing the mean/average value of the plotted variable:
