...
fs::dir_info("raw/wvs7", glob = c("*.zip", "*.sav", "*.pdf"))[, c(1,3)] |> gt::gt_preview() |> gt::cols_align(align = "left") |> gt::tab_options(table.width = "70%")
...
data_write(wvs7, "for_analysis/wvs7.rds")
